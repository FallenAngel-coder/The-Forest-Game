...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Weapon : WeaponBehaviour
    {
        ...
        public event Action<bool> OnFire = delegate { }; // Подія, яка буде сповіщати інші скрипти про вистріл
        ...
        public override int GetMaximumReloads() => magazineBehaviour.GetMaximumReloads();
