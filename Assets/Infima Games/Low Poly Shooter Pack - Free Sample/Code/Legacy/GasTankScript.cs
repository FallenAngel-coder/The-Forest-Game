...
public class GasTankScript : MonoBehaviour {
	...
	private IEnumerator Explode ()
	{
        ...
        Transform destroyedGasTank = Instantiate(destroyedGasTankPrefab, transform.position, transform.rotation);
        float destructionTime = Random.Range(2f, 12f) - 5f; // Рандомний час з розкидом +-5 секунд
        Destroy(destroyedGasTank.gameObject, destructionTime); // Знищити префаб після випадкового часу
