...
public class ExplosiveBarrelScript : MonoBehaviour {
	...
	private IEnumerator Explode () {
        ...
        Transform destroyedBarrel = Instantiate(destroyedBarrelPrefab, transform.position, transform.rotation);
        float destructionTime = Random.Range(2f, 12f) - 5f; // Рандомний час з розкидом +-5 секунд
        Destroy(destroyedBarrel.gameObject, destructionTime); // Знищити префаб після випадкового часу
